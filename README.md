...
The backend exposes Prometheus metrics at `/metrics`. Alert rules, Alertmanager configuration, a Grafana dashboard, and the metric catalog are documented in [docs/metrics.md](docs/metrics.md).
